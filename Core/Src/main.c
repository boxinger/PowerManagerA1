...
#include "pwm_ctrl.h" // 包含控制逻辑
#include "ui.h"  // 包含 UI 逻辑
#include "KeyFilter.h"
#include "sample.h"
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	/* 1. 初始化控制系统*/
    PWM_Ctrl_Init_And_Detect();

    /* 2. 设定电源目标: 目标 12.0V, 限流 1.0A */
...
//	PWM_Set_Right_Duty_Percent(40);
//	PWM_Set_Left_Duty_Percent(40);
